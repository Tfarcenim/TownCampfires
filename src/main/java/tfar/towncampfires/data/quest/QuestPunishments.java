...
public class QuestPunishments {


    public static final QuestPunishments EMPTY = new QuestPunishments(0,0, new ResourceLocation[0], new ResourceLocation[0], CommandFunction.CacheableFunction.NONE);
    ...
    public QuestPunishments(int playerExperience, int campfireExperience, ResourceLocation[] pLoot, ResourceLocation[] pRecipes, CommandFunction.CacheableFunction pFunction) {
    ...
    public static QuestPunishments readFromPacket(FriendlyByteBuf buf) {
        return EMPTY;
    }
    ...
    public static QuestPunishments deserialize(JsonObject pJson) throws JsonParseException {
        if (pJson == null) {
            return EMPTY;
        }
        ...
        return new QuestPunishments(experience,campfireExperience, aresourcelocation, aresourcelocation1, commandfunction$cacheablefunction);
    }
    ...
    public static class Builder {
        ...
        public QuestPunishments build() {
            return new QuestPunishments(this.experience,campfireExperience, this.loot.toArray(new ResourceLocation[0]), this.recipes.toArray(new ResourceLocation[0]), this.function == null ? CommandFunction.CacheableFunction.NONE : new CommandFunction.CacheableFunction(this.function));
        }
    }
}
