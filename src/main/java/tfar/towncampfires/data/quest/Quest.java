...
public record Quest(Component name, ItemStack icon, List<Component> desc,
                    ...
                    SuccessCriteria successCriteria, QuestRewards rewards,
                    FailureCriteria failureCriteria, QuestRewards punishments,
                    boolean levelUp, long weight, Component compactName, List<Component> compactDesc, int difficulty,
                    int slots, int attempts,
    ...
    public JsonObject write() {
        ...
        jsonObject.add("criteria", successCriteria.serializeToJson());
    ...
    public static Quest read(JsonObject object, DeserializationContext context) {
        ...
        var criterias = SuccessCriteria.deserialize(object.getAsJsonObject("criteria"), context);
    ...
    public void toPacket(FriendlyByteBuf buf) {
        ...
        buf.writeEnum(type);
        successCriteria.serializeToNetwork(buf);
    ...
    public static Quest fromPacket(FriendlyByteBuf buf) {
        return new Quest(buf.readComponent(), buf.readItem(), buf.readList(FriendlyByteBuf::readComponent),
                ...
                SuccessCriteria.fromNetwork(buf), QuestRewards.readFromPacket(buf),
